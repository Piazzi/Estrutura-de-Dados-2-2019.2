...
/**
 * Algoritmo de particionamento do m�todo de quick sort recursivo para objetos
 *
...
/**
 * Utiliza o algoritmo de Quick Sort recursivo para ordenar um dado array de inteiros
 *
 * @param int arr[]
 * @param int inicio
 * @param int fim
...
void QuickSort::quickSort(int arr[], int tam)
{
	...
	cout << "Tempo de execucao e ordenacao para N = " <<tam<<": " << tempoExecucao << " Nanossegundos"<< endl;
	cout << "Numero de comparacoes: " << numComparacoes << endl;
	cout << "Numero de copias: " << numCopias << endl << endl;
	numComparacoes = 0;
	numCopias = 0;
}
